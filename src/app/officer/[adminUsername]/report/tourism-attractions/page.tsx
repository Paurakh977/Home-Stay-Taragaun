...
export default function OfficerTourismAttractionsPage() {
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-auto">
        <ReportPage
          ...
          description="Explore data on local tourism attractions, cultural sites, and natural landmarks near homestays."
