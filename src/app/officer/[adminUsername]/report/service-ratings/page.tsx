...
export default function OfficerServiceRatingsPage() {
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-auto">
        <ReportPage
          ...
          description="Review and analyze customer ratings, feedback, and service quality metrics across homestays."
