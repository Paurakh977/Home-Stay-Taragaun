...
import { Plus, Trash, Upload, GripVertical } from "lucide-react";
import { z } from "zod";
...
// Define the ITeamMember interface
...
// Define the IAboutPage interface
...
// Define validation schema for team
...
// Define schema for team section
...
export default function TeamEditor() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>, index: number) => {
    ...
    try {
      ...
      form.setValue(`members.${index}.photoPath`, data.imagePath, { shouldValidate: true });
  ...
  const handleReorder = (index: number, newOrder: number) => {
    form.setValue(`members.${index}.order`, newOrder, { shouldValidate: true });
  };
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage the team section that appears on the About page
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
