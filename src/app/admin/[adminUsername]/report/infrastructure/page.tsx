  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-auto">
        <ReportPage
          title="Physical Infrastructure and Amenities"
          description="Analyze data on physical infrastructure, facilities, amenities, and accessibility features across homestays."
          type="infrastructure"
          userType="admin"
